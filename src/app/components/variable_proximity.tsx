...
const VariableProximity = forwardRef<HTMLSpanElement, VariableProximityProps>((props, ref) => {
    const {
        ...
        containerRef,
        radius = 150, // increased radius for easier proximity testing
        falloff = "linear",
        className = "",
        onClick,
        style,
    ...
    useAnimationFrame(() => {
        ...
        // Debug log to check animation frame updates and mouse position
        // console.log("Animation frame, mouse pos:", x, y);
                        ...
                        return (
                            <motion.span
                                ...
                                style={{
                                    ...
                                    // Use fallback fontVariationSettings on initial render
