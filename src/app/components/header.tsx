    ...
    <div className="sticky top-0 z-50 bg-black" id="header">
      <div className="bg-gray-900 py-6 border-b border-slate-800 flex justify-between items-center px-4 lg:px-9">
        ...
        <div className="lg:hidden flex items-center justify-between w-full">
          ...
          {/* Center: Logo */}
          <h1 className="text-xl font-semibold text-white">ResumeBuilder Pro</h1>

          {/* Right: Sign Up */}
          <button
            onClick={() => router.push("/signup")}
            className="rounded-lg px-4 py-2 text-sm font-bold bg-gradient-to-r from-blue-600 to-cyan-500 text-white shadow hover:from-blue-700 hover:to-cyan-600 transition-all"
          >
            Sign Up
          </button>
        </div>
